...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'unili@lizncu.onmicrosoft.com',
  ...
  protectedRoutes: ['/🌞 PPTA', '/🥟 WWW/PPPTA'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:lizncu.unili@gmail.com',
